...
const en = {
  ...
  applications: {
    title: 'My LOTTE',
    subtitle: 'Your plans, subscriptions and roaming — in one place.',
    empty: 'Nothing here yet.',
    emptyCta: 'Explore plans & roaming',
  ...
  // ── Home hub ─────────────────────────────────────────────────────────
  hub: {
    title: 'Mobile for everyday & every trip',
    subtitle: 'A monthly plan for home, prepaid roaming for travel — both with L.POINT benefits.',
    note: 'Demo MVP — prices, benefits and terms that are not finalized will be announced separately.',
    mvno: {
      eyebrow: 'EVERYDAY',
      title: 'Mobile plans',
      desc: 'No-contract monthly plans (LTE · 5G) on KT, SKT and LGU+ networks.',
      cta: 'See plans',
    },
    roaming: {
      eyebrow: 'TRAVEL',
      title: 'Travel roaming',
      desc: 'Prepaid eSIM & USIM for Korea and abroad. Activate in minutes.',
      cta: 'Find roaming',
    },
  },

  // ── MVNO (domestic monthly plans) ────────────────────────────────────
  mvno: {
    catalogTitle: 'Mobile plans',
    catalogSub: 'No-contract monthly plans (알뜰폰) on Korea’s major networks.',
    catalogNote: 'Sample pricing. Promotional rates apply for the first months; benefits to be announced.',
    noResults: 'No plans match these filters.',
    all: 'All',
    techLabel: 'Network type',
    networkLabel: 'Network',
    networkName: { KT: 'KT', SKT: 'SKT', LGU: 'LG U+' } as Record<'KT' | 'SKT' | 'LGU', string>,
    perMonth: 'month',
    dataLabel: 'Data',
    voiceLabel: 'Calls',
    smsLabel: 'Texts',
    ...
    min: ' min',
    smsUnit: ' SMS',
    smsUnlimited: 'Unlimited SMS',
    callsUnlimited: 'Unlimited calls',
    detail: 'Details',
    perksTitle: 'Included benefits',
    apply: 'Sign up',
    priceNote: 'Sample monthly price · taxes included.',
    promoMonths: (n: number) => `Promo · first ${n} months`,
    promoFull: (regular: string, months: number) =>
      `Promotional price for the first ${months} months, then ₩${regular}/month.`,
    notices: [
      'A no-contract monthly plan; cancel anytime with no penalty.',
      'Identity verification (본인확인) is required to open a line, by law.',
      'After the monthly data cap, speed is limited (varies by plan) until the next cycle.',
      'eSIM works on eSIM-capable devices; USIM ships before activation.',
    ] as string[],
    usageTitle: 'This month',
    lowWarning: 'Monthly data is running low.',
    planLabel: 'Plan',
  },
  ...
  mvnoStatus: {
    ...
    active: 'Active',
    failed: 'Failed',
  } as Record<'submitted' | 'pending_activation' | 'active' | 'failed', string>,

  subscribe: {
    summaryTitle: 'Subscription summary',
    infoTitle: 'Your details',
    infoSub: 'We need the subscriber’s info and identity check to open the line.',
    port: 'Number',
    portMove: 'Keep my number',
    portNew: 'New number',
    name: 'Full name',
    namePh: 'Name on your ID',
    birth: 'Date of birth',
    phonePort: 'Number to transfer',
    phoneNew: 'Contact number',
    currentCarrier: 'Current carrier',
    currentCarrierPh: 'e.g. SKT / KT / LG U+',
    pay: 'Payment method',
    payCard: 'Card',
    payBank: 'Bank transfer',
    kycTitle: 'Identity verification',
    kycNote: 'A quick identity check (본인확인) runs before activation. Demo: simulated.',
    confirmTitle: 'Review & subscribe',
    confirmSub: 'Check your details and agree to monthly auto-payment.',
    firstCharge: 'First month',
    autopayNote: 'Auto-payment is mocked; this places the subscription for now.',
    agree: 'I agree to the plan terms and monthly auto-payment (required).',
    placeCta: 'Subscribe',
    completeTitle: 'You’re subscribed',
    completeSub: 'Your plan is being activated.',
    subNo: 'Subscription no.',
    esimNext: 'Your eSIM QR was sent by email. Install it and finish activation.',
    usimNext: 'Your USIM ships to your address (1–2 days). Insert it to activate.',
    billingFrom: 'Next billing',
  ...
  mySub: {
    ...
    activateCta: 'Mark as activated',
    manageNote: 'Changes and cancellation will be available via customer support.',
  },
